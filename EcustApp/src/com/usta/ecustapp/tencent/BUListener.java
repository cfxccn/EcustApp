package com.usta.ecustapp.tencent;
...
public class BUListener implements IUiListener {
	...
	public BUListener(Context mContext) {
		super();
		this.mContext = mContext;
	}

	
	public BUListener(Context mContext, String mScope) {
		super();
		this.mContext = mContext;
		this.mScope = mScope;
	}
