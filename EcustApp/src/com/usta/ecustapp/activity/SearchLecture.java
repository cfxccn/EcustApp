...
public class SearchLecture extends ActionBarActivity {
			...
			public void run() {
				try {
					...
					if (lectureArray != null) {
						...
						ToastUtil.showToastShort(getApplicationContext(), "无讲座信息");
						return;
					}
				} catch (Exception e) {
	...
	protected void initlistview() {
		...
		for (int i = 0; i < lectureArray.length(); i++) {
			...
			map.put("textView_lecturetitle",
					lectureJsonObject.optString("lecturetitle").trim());
			map.put("textView_report", lectureJsonObject.optString("reporter")
					.trim());
			map.put("textView_lecturetime",
					lectureJsonObject.optString("lecturetime")
		...
		SimpleAdapter listItemAdapter = new SimpleAdapter(this, listItem,// 数据源
				...
				// 动态数组与ImageItem对应的子项
				new String[] { "textView_lectureid", "textView_lecturetitle",
						"textView_report", "textView_lecturetime" },
		...
		listViewNewsMoreTitles
				.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> arg0, View arg1,
						...
						lectureid = String.valueOf(map
								.get("textView_lectureid"));
